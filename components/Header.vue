<template>
    <nav flex="~ " justify="between lg:center" px="5 lg:10 xl:15" h="20" items="center" bg="#D9D9D9" font="sans"
        ...
        <!-- HUMBERGER ICON -->
        <Icon  @click="toggleSidebar()" cursor="pointer" name="ic-baseline-menu" text="2xl" class="!md:hidden relative z-3" />
        <div ref="sidebarRef"  w="full" h="full" class="fixed top-0 bottom-0 right-115 z-3 block md:hidden hideSideBar"  transition="all ease-in-out 0.3s">
